...
RED_LED_PIN = 1         # 红灯引脚
BLUE_LED_PIN = 3        # 蓝灯引脚
SAVE_PATH = 'singtown'    # 图片保存的位置The location where the picture is saved
num = 1 # 设置被拍摄者序号Set the serial number of the person being photographed

n = 20  # 设置每个人拍摄图片数量Set the number of pictures taken by each person.

# 初始化函数initialization function
def init_setup():
    global sensor
...
def main():
    ...
    while (n):
        ...
        #保存截取到的图片到SD卡Save the captured image to SD card
        print(n)
